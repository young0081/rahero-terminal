...
- 💬 **飞讯系统**：角色对话剧本（占位剧情），支持UGC创作、导出导入
- 📚 **势力档案**：13个势力详细资料，数据来自萌娘百科，自动更新
- 💙 **好感度系统**：6个等级（陌生→挚友），互动增长，解锁提示
...
#### 新功能
- 💙 **好感度系统**：6个等级，互动增长，等级提升弹窗提示
- ✍️ **UGC剧本系统**：创作、编辑、分享自定义剧本，导出导入功能
- 🎨 **声骸GIF优化**：技能演示图放大显示，点击全屏查看
- 🌐 **势力档案改造**：切换到萌娘百科数据源，13个势力完整资料

#### 移除功能
- ❌ 每日签到/祝福（保持内容真实性）

#### 重要说明
- 📝 飞讯剧本目前为**占位内容**，非游戏真实剧情
